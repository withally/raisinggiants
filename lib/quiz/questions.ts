 ...
 *
 * 28 questions covering all 11 scoring dimensions across two lenses:
 * - Past lens: memory-based questions about how the parent was raised
 * - Current lens: behavioral questions about how the parent parents today
 *
...
export const SECTIONS: QuizSection[] = [
  ...
  {
    id: 'your-parenting-today',
    title: 'Your Parenting Today',
  },
  {
    id: 'your-background',
...
export const QUESTIONS: QuizQuestion[] = [
  ...
  // =========================================================================
  // SECTION: Your Parenting Today
  // =========================================================================

  // --- Emotional Warmth (current) ---

  {
    id: 'q-warmth-current-01',
    lens: 'current',
    section: 'your-parenting-today',
    question:
      "When your child comes to you after a tough day, what's your most natural first move?",
    inputType: 'option-cards',
    options: [
      { id: 'hug-listen', label: 'Offer a hug and ask them what happened' },
      { id: 'give-space', label: 'Give them some space to settle before I check in' },
      { id: 'practical', label: 'Try to solve whatever the problem was' },
      { id: 'affirm', label: "Tell them it'll be okay and remind them of their strengths" },
    ],
    dimensionScores: {
      'hug-listen':  { 'emotional-warmth': 9, 'presence-attunement': 9 },
      'give-space':  { 'emotional-warmth': 6, 'presence-attunement': 6 },
      practical:     { 'emotional-warmth': 5, 'autonomy-support': 5 },
      affirm:        { 'emotional-warmth': 7, 'nonjudgmental-acceptance': 7 },
    },
  },

  // --- Emotional Regulation (current) ---

  {
    id: 'q-regulation-current-01',
    lens: 'current',
    section: 'your-parenting-today',
    question:
      "When your child is having a meltdown or a big emotional outburst, what's your internal experience usually like?",
    inputType: 'option-cards',
    options: [
      { id: 'grounded', label: "I can usually stay grounded and focus on them" },
      { id: 'tense', label: "I feel myself getting tense or frustrated" },
      { id: 'overwhelmed', label: "I find it genuinely overwhelming — I often need a moment myself" },
      { id: 'varies', label: "It really varies — some days I'm solid, other days I struggle" },
    ],
    dimensionScores: {
      grounded:    { 'emotional-regulation': 9, 'presence-attunement': 8 },
      tense:       { 'emotional-regulation': 5 },
      overwhelmed: { 'emotional-regulation': 2 },
      varies:      { 'emotional-regulation': 5 },
    },
  },

  {
    id: 'q-regulation-current-02',
    lens: 'current',
    section: 'your-parenting-today',
    question:
      "How often do you find yourself saying things to your child you later regret — things said in a heated moment that you'd take back if you could?",
    inputType: 'option-cards',
    options: [
      { id: 'rarely', label: "Rarely — I usually catch myself before it gets there" },
      { id: 'sometimes', label: "Sometimes — a few times a month" },
      { id: 'often', label: "More than I'd like — several times a week" },
      { id: 'frequently', label: "Quite a lot — it's an ongoing struggle for me" },
    ],
    dimensionScores: {
      rarely:     { 'emotional-regulation': 9 },
      sometimes:  { 'emotional-regulation': 6 },
      often:      { 'emotional-regulation': 3 },
      frequently: { 'emotional-regulation': 1 },
    },
  },

  // --- Autonomy Support (current) ---

  {
    id: 'q-autonomy-current-01',
    lens: 'current',
    section: 'your-parenting-today',
    question:
      "When your child is struggling with something they could figure out given enough time, what's your instinct?",
    inputType: 'option-cards',
    options: [
      { id: 'wait', label: "Wait and let them work through it — even when it's hard to watch" },
      { id: 'hints', label: 'Offer gentle hints to nudge them in the right direction' },
      { id: 'step-in', label: 'Step in and help them get unstuck' },
      { id: 'take-over', label: 'Take over so we can move forward' },
    ],
    dimensionScores: {
      wait:     { 'autonomy-support': 9 },
      hints:    { 'autonomy-support': 7 },
      'step-in':{ 'autonomy-support': 4 },
      'take-over': { 'autonomy-support': 1 },
    },
  },

  // --- Boundary Consistency (current) ---

  {
    id: 'q-boundary-current-01',
    lens: 'current',
    section: 'your-parenting-today',
    question:
      "When you set a limit with your child and they really push back, what usually happens?",
    inputType: 'option-cards',
    options: [
      { id: 'hold-firm', label: "I hold the line — kindly but firmly" },
      { id: 'usually-hold', label: "I usually hold it, though I occasionally give a little" },
      { id: 'negotiate', label: "We often end up renegotiating depending on the situation" },
      { id: 'often-give-in', label: "I often find myself giving in if they push hard enough" },
    ],
    dimensionScores: {
      'hold-firm':    { 'boundary-consistency': 9 },
      'usually-hold': { 'boundary-consistency': 7 },
      negotiate:      { 'boundary-consistency': 5, 'reciprocity': 7 },
      'often-give-in':{ 'boundary-consistency': 2 },
    },
  },

  // --- Presence / Attunement (current) ---

  {
    id: 'q-attunement-current-01',
    lens: 'current',
    section: 'your-parenting-today',
    question:
      "When your child goes quiet or withdraws, how often can you tell with confidence what's going on for them — whether they're tired, bothered by something, or just fine?",
    inputType: 'option-cards',
    options: [
      { id: 'usually', label: "Usually — I have a pretty good read on them" },
      { id: 'sometimes', label: "Sometimes — though I'm not always certain" },
      { id: 'often-wrong', label: "I often find I've misread it once I check in" },
      { id: 'rarely', label: "Rarely — their inner world feels quite opaque to me" },
    ],
    dimensionScores: {
      usually:      { 'presence-attunement': 9 },
      sometimes:    { 'presence-attunement': 6 },
      'often-wrong':{ 'presence-attunement': 3 },
      rarely:       { 'presence-attunement': 1 },
    },
  },

  // --- Repair / Reconnection (current) ---

  {
    id: 'q-repair-current-01',
    lens: 'current',
    section: 'your-parenting-today',
    question:
      "When you've been too sharp, impatient, or harsh with your child, what usually comes next?",
    whyWeAskThis:
      "One of the most powerful things a parent can do is come back after a difficult moment and name what happened. This isn't about being a perfect parent — it's about repair. Understanding your natural response here helps us give you a result that reflects how you actually show up.",
    inputType: 'option-cards',
    options: [
      { id: 'go-back', label: 'I go back and acknowledge what happened as soon as I can' },
      { id: 'usually-go-back', label: 'I usually go back, though not immediately' },
      { id: 'move-on', label: 'I focus on what comes next and mostly move forward' },
      { id: 'feel-bad', label: "I feel bad about it but don't usually address it directly" },
    ],
    dimensionScores: {
      'go-back':       { 'repair-reconnection': 9 },
      'usually-go-back':{ 'repair-reconnection': 7 },
      'move-on':       { 'repair-reconnection': 4 },
      'feel-bad':      { 'repair-reconnection': 2 },
    },
  },

  // --- Protective Instinct (current) ---

  {
    id: 'q-protective-current-01',
    lens: 'current',
    section: 'your-parenting-today',
    question:
      "When your child wants to do something that feels slightly risky — climbing higher, going somewhere alone for the first time, trying something new — what's your honest instinct?",
    inputType: 'option-cards',
    options: [
      { id: 'encourage', label: 'Encourage them and stay nearby if they need support' },
      { id: 'assess', label: 'Assess carefully and decide based on the specific situation' },
      { id: 'cautious', label: 'Feel cautious but try to hold back my concern' },
      { id: 'no', label: "Usually say no, or wait until I feel they're ready" },
    ],
    dimensionScores: {
      encourage: { 'protective-instinct': 2, 'autonomy-support': 8 },
      assess:    { 'protective-instinct': 5, 'autonomy-support': 6 },
      cautious:  { 'protective-instinct': 7 },
      no:        { 'protective-instinct': 9, 'autonomy-support': 2 },
    },
  },

  // --- Nonjudgmental Acceptance (current) ---

  {
    ...
    section: 'your-parenting-today',
    question:
      "When your child does something that genuinely disappoints you, how easy is it to communicate that the behaviour was the problem — without letting them feel that something is wrong with them?",
    inputType: 'option-cards',
    options: [
      { id: 'very-easy', label: "Very natural — I can hold both things at once without much effort" },
      { id: 'usually', label: "Usually — though I don't always get it right" },
      { id: 'hard', label: "Hard — I notice my disappointment does colour how I come across" },
      { id: 'very-hard', label: "Really hard — when I'm disappointed it tends to show" },
    ],
    dimensionScores: {
      'very-easy': { 'nonjudgmental-acceptance': 9 },
      usually:     { 'nonjudgmental-acceptance': 7 },
      hard:        { 'nonjudgmental-acceptance': 4 },
      'very-hard': { 'nonjudgmental-acceptance': 1 },
    },
  },
  ...
  {
    id: 'q-reciprocity-current-01',
    lens: 'current',
    section: 'your-parenting-today',
    question:
      "When you're making a decision that affects your child — a change of plans, a new rule, something big — how often do you genuinely factor in their perspective?",
    inputType: 'option-cards',
    options: [
      { id: 'almost-always', label: 'Almost always — their view often shifts the outcome' },
      { id: 'often', label: 'Often — I ask, and it sometimes changes my mind' },
      { id: 'sometimes', label: 'Sometimes — especially on bigger things' },
      { id: 'rarely', label: "Rarely — I make most decisions and then let them know" },
    ],
    dimensionScores: {
      'almost-always': { 'reciprocity': 9 },
      often:           { 'reciprocity': 7 },
      sometimes:       { 'reciprocity': 5 },
      rarely:          { 'reciprocity': 2 },
    },
  },

  // --- Role Integrity (current) ---

  {
    id: 'q-role-current-01',
    lens: 'current',
    section: 'your-parenting-today',
    question:
      "When you're having a hard day, how aware are your children of your emotional state?",
    whyWeAskThis:
      "Children are naturally attuned to their parents' emotions — that's healthy and normal. What we're looking at here is whether your child seems to adjust their behaviour to manage or protect you. That's a subtle but important distinction.",
    inputType: 'option-cards',
    options: [
      {
        id: 'dont-notice',
        label: "They usually don't notice — I keep it pretty separate",
      },
      {
        id: 'notice-not-change',
        label: "They notice, but it doesn't seem to change how they act",
      },
      {
        id: 'change-some',
        label: 'They sometimes seem to adjust — being a bit quieter or more careful',
      },
      {
        id: 'manage-mood',
        label: 'They seem quite aware and try to cheer me up or manage around my mood',
      },
    ],
    dimensionScores: {
      'dont-notice':   { 'role-integrity': 9 },
      'notice-not-change': { 'role-integrity': 7 },
      'change-some':   { 'role-integrity': 4 },
      'manage-mood':   { 'role-integrity': 2 },
    },
  },
