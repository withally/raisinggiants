 ...
 *
 * Each theme renders as a visually distinct block with a left amber border accent.
 * Citations collapse behind a <details>/<summary> toggle (zero JS).
 *
 * Background: bg-white (alternating contrast with amber-50 hero and stone-50 watchouts).
 */
  ...
  return (
    <section className="bg-white py-16 sm:py-20 px-6">
      <div className="max-w-3xl mx-auto">
        ...
        {/* Themes — each as a styled block with amber left border */}
        <div className="space-y-5 mb-12">
          {patterns.themes.map((theme) => {
            ...
            return (
              <div key={theme.slice(0, 40)} className="border-l-4 border-amber-400 pl-5 py-2">
        ...
        {/* Research anchor */}
        <p className="text-sm italic text-stone-500 leading-relaxed mb-8 border-t border-stone-100 pt-6">
