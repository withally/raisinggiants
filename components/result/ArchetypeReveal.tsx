 ...
 *
 * This is the emotional core of The Mirror. Full viewport height, centered,
...
export function ArchetypeReveal({ archetype }: ArchetypeRevealProps) {
  return (
    <section className="min-h-[80dvh] flex flex-col items-center justify-center bg-amber-50 px-6 py-20 sm:py-28">
      <div className="max-w-2xl mx-auto text-center">
        {/* Eyebrow */}
        <p className="text-xs tracking-[0.25em] uppercase text-stone-400 font-medium mb-6">
          You were raised by:
        </p>

        {/* Archetype name — dramatic display font reveal */}
        <h1
          className="text-4xl sm:text-5xl md:text-6xl font-semibold text-stone-900 mb-5 leading-tight"
        ...
        {/* Tagline */}
        <p className="text-xl italic text-stone-600 mb-10 leading-relaxed">{archetype.tagline}</p>
