        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-2 sm:gap-3 mb-12">
            {archetypes.map((name, i) => (
              ...
              >
                <span className="inline-flex items-center rounded-full border border-amber-200 bg-amber-50/60 px-4 py-2 text-sm text-stone-700 transition-colors hover:border-amber-400 hover:bg-amber-50">
                  {name}
                </span>
              </ScrollReveal>
            ))}
          ...
          <ScrollReveal delay={200}>
            <div className="bg-stone-50 border border-stone-200 rounded-2xl p-6 sm:p-8 max-w-lg mx-auto text-left">
              ...
              <p className="text-lg sm:text-xl text-stone-800 leading-relaxed mb-6 font-display">
